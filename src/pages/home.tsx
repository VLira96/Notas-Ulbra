const Home = () => {
    return (
        <div className="p-10 flex items-center flex-col gap-10 lg:gap-12">
            <h1 className="text-5xl">Novo sistema de nota</h1>

            <section className="flex flex-col gap-4 lg:gap-8 lg:mx-64">
